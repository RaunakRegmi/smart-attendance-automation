...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _loadAlertConfig() async {
    ...
    if (!mounted) return;
    setState(() { _beforeMinutes = before; });
      ...
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: () async {
            await context.read<DashboardProvider>().loadDashboard();
            if (!mounted) return;
            await context.read<NotificationProvider>().loadNotifications(); // ignore: use_build_context_synchronously
            if (!mounted) return;
            await context.read<ScheduleProvider>().loadWeeklySchedule(); // ignore: use_build_context_synchronously
            if (!mounted) return;
            await _loadAvatar();
          },
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Builder(builder: (_) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(color: color.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,6))),
        ...
        Expanded(child: ListView.separated(
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              onTap: () => onRead(n.id),
              child: Container(
                color: n.isRead ? Colors.transparent : AppTheme.primary.withValues(alpha: 0.04),
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Container(width: _rs(context,42), height: _rs(context,42),
                    decoration: BoxDecoration(color: _color(n.type).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,12))),
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    padding: EdgeInsets.symmetric(horizontal: _rs(context,8), vertical: _rs(context,3)),
    decoration: BoxDecoration(color: color.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,20)), border: Border.all(color: color.withValues(alpha: 0.3))),
...
class _LogItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        Container(width: _rs(context,30), height: _rs(context,30), decoration: BoxDecoration(color: color.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,8))), child: Icon(icon, color: color, size: _rs(context,16))),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            Container(
              ...
              decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(_rs(context,10))),
          ...
          Container(
            ...
            decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,12))),
            child: Row(children: [
              _MiniStat(
          ...
          if (tomorrowPreview != null) ...[
            ...
            SizedBox(height: _rs(context,10)),
            Row(children: [
              Icon(Icons.light_mode_outlined, color: Colors.white.withValues(alpha: 0.6), size: _rs(context,12)),
              SizedBox(width: _rs(context,5)),
            ...
            Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(_rs(context,8))),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ...List.generate(classes.length, (i) {
          ...
          if (isCurrent) {
            ...
            leading = SizedBox(width: _rs(context,24), height: _rs(context,24),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            child: Row(children: [
              Container(
                padding: EdgeInsets.symmetric(horizontal: _rs(context,8), vertical: _rs(context,3)),
                decoration: BoxDecoration(color: AppTheme.primary.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,6))),
          ...
          // List
          if (classes.isEmpty)
            const Padding(padding: EdgeInsets.all(32), child: Text('No classes', style: TextStyle(color: AppTheme.textSecondary)))
          else
            Flexible(
                  ...
                  return Container(
                    ...
                    child: Row(children: [
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppTheme.primary.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(_rs(context,10))),
...
//         boxShadow: [BoxShadow(color: AppTheme.accent.withValues(alpha: 0.3), blurRadius: 16, offset: const Offset(0, 6))]),
//       child: Row(children: [
