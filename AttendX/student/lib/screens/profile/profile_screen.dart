    ...
    try {
      cropped = await ImageCropper().cropImage(
        ...
        uiSettings: [
          ...
          WebUiSettings(context: context, presentStyle: WebPresentStyle.dialog), // ignore: use_build_context_synchronously
        ],
      );
    } catch (_) {
      cropped = null;
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ListTile(
            leading: Container(width: 44, height: 44, decoration: BoxDecoration(color: AppTheme.accent.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(12)),
            ...
            ElevatedButton(
              onPressed: saving ? null : () async {
                ...
                try {
                  ...
                  if (!mounted) return;
                  Navigator.pop(dialogCtx); // ignore: use_build_context_synchronously
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const _AboutRow('Platform', 'Flutter 3.x'),
          const _AboutRow('Build',    '2024.01.15'),
          const _AboutRow('Team',     'Group Project — CS Dept'),
        ]),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context),
            child: const Text('Close', style: TextStyle(color: AppTheme.primary))),
                ...
                child: Column(children: [
                  ...
                  _ActionTile(Icons.edit_outlined, 'Edit Personal Details',
                      ...
                      onTap: () async {
                        ...
                        if (!mounted) return;
                        if (changed == true) {
                          context.read<DashboardProvider>().loadDashboard(); // ignore: use_build_context_synchronously
                        }
                      }),
                ]),
              )),
